...
public class APIToBigQuery implements BaseTemplate {
  ...
  public APIToBigQuery(APIToBigQueryConfig config) {
  ...
  public static APIToBigQuery of(String... args) {
    APIToBigQueryConfig config = APIToBigQueryConfig.fromProperties(PropertyUtil.getProperties());
    ValidationUtil.validateOrThrow(config);
    LOGGER.info("Config loaded\n{}", config);
    return new APIToBigQuery(config);
  }
